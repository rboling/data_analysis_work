...
input2 = csv.reader(open("Div Yield Data.csv"))
class UnicodeWriter:
    """
...
output = open("div_yield_project_three.csv", "wb")
writer = UnicodeWriter(output)

for line in input2:
    if line[0] != "Ticker" and line[0] != "EV TO T12M EBITDA" and line[0] != None and line[0] != "DIVIDEND YIELD":
