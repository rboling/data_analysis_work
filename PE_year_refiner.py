...
input2 = csv.reader(open("PE Data.csv"))
class UnicodeWriter:
    """
...
for line in input2:
    ...
    if line[0] != '3/28/2013' and line[0] != "Ticker" and line[0] != "EV TO T12M EBITDA" and line[0] != None and line[0] != "":
