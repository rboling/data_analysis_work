...
input2 = csv.reader(open("return_on_eq_2007.csv"))
class UnicodeWriter:
    """
...
output = open("return_on_eq_2007_refined.csv", "wb")
writer = UnicodeWriter(output)

for line in input2:
    if line[0] != "Ticker" and line[0] != "EV TO T12M EBITDA" and line[0] != None and line[0] != "":
