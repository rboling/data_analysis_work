...
input2 = csv.reader(open("Return on Equity Data.csv"))
class UnicodeWriter:
    """
...
output = open("return_on_equity.csv", "wb")
writer = UnicodeWriter(output)

for line in input2:
    if line[0] != "Ticker" and line[0] != "RETURN COM EQY" and len(line) > 0 and line[0] != "": 
