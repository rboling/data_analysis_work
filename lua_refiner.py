...
with open('Lua_scraping_output.csv', 'rb') as csvfile:
  ...
  for row in reader:
    ...
    #  year = split_even_more[2]
      ...
      if split_row == '2012':	  
        writer.writerow(["Lua Programming Language", split_row, real_bytes, row[5], row[6], row[5], row[6]])
      else:
        writer.writerow(["Lua Programming Language", split_row, real_bytes, row[5], row[6], "", ""])
